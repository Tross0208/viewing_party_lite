...
RSpec.describe "User Dashboard/Show Page", type: :feature do
  ...
  it 'shows the viewing parties they were invited to', :vcr do
    user_1 = User.create!(name: "Joe", email: "joe@mail.com", username: "BubbaGump", password: "passpass")
    user_2 = User.create!(name: "Amy", email: "amy@mail.com", username: "BubbaGump2", password: "passpass")
